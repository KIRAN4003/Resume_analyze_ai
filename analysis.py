...
def analyze_resume(pdf_doc,job_des):
    ...
    ats_score = model.generate_content(f'''Compare the resume {pdf_text} with the job description {job_des} and get ATS score
                                       in scale of 0 to 100.
                                       enerate the results in bullet points (minimum 5 points).''')
